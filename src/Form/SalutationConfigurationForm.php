...
class SalutationConfigurationForm extends ConfigFormBase
{
    ...
    {
        return ['hello.custom_salutation'];
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $config = $this->config('hello.custom_salutation');
    ...
    public function validateForm(&$form, FormStateInterface $form_state)
    {
        ...
        if (strlen($salutation) > 20){
            $form_state->setErrorByName('salutation', $this->t('This greeting is too long.'));
        }
    }
    /**
     * {@inheritdoc}
    ...
    {
        $this->config('hello.custom_salutation')
